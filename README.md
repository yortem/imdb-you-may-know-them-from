...
4. Each card in the new section has a small Google icon (bottom-right) that opens a Google Images search for `<title> <actor>` in a new tab, in case you want to remember what they looked like in that title
